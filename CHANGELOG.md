...
- Removes environment-default routing from business operations, requires exact repository mappings, and live-verifies marker and registry targets for the issuer + subject account before reads or writes.
